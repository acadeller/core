...
export const content: Record<Lang, LandingContent> = {
  en: {
    ...
    ctaMail: "hello@acadeller.com",
    footTag: "A small software studio building thoughtful products for ambitious teams. Madrid + Remote.",
    footWork: "Work",
    footServ: "Services",
    footSocial: "Find us",
    footMeta: "© 2026 Acadeller · Crafted in Madrid",
  ...
  es: {
    ...
    ctaMail: "hello@acadeller.com",
    footTag: "Un estudio de software pequeño que construye productos cuidados para equipos ambiciosos. Madrid + Remoto.",
    footWork: "Trabajos",
    footServ: "Servicios",
    footSocial: "Encuéntranos",
    footMeta: "© 2026 Acadeller · Hecho en Madrid",
